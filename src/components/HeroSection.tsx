    ...
    <section id="beranda" className="relative min-h-screen flex items-center bg-gradient-to-br from-background via-background to-brand-teal/10 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-foreground font-heading">
                <span className="text-accent">Bangkit</span> Bersama Kami
              </h2>
            </div>

            <p className="text-lg sm:text-xl text-foreground/80 leading-relaxed max-w-2xl font-sans text-justify">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="/cek-kondisi-mental">
                <Button
                  size="lg"
                  className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-8 py-6 text-lg rounded-xl transition-all duration-300 transform hover:scale-105 font-sans"
                >
              ...
              <a href="/tentang-kami">
                <Button
                  variant="outline"
                  size="lg"
                  className="border-secondary text-secondary hover:bg-secondary hover:text-secondary-foreground font-semibold px-8 py-6 text-lg rounded-xl transition-all duration-300 font-sans"
                >
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="bg-brand-yellow/10 border border-brand-yellow/30 rounded-xl p-6 text-center">
